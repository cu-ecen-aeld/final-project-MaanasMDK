...
SRC_URI = "git://git@github.com/cu-ecen-aeld/final-project-nihalthirunakarasu;protocol=ssh;branch=main"
...
S = "${WORKDIR}/git/opencv_app_file"

# TODO: Add the aesdsocket application and any other files you need to install
# See https://git.yoctoproject.org/poky/plain/meta/conf/bitbake.conf?h=kirkstone
FILES:${PN} += "${bindir}/aesd_opencv_file"
...
do_install () {
	...
	install -d ${D}${bindir}
	install -m 0755 ${S}/aesd_opencv_file ${D}${bindir}
	install -m 0755 ${WORKDIR}/git/test_videos/test.mp4 ${D}${bindir}
}
